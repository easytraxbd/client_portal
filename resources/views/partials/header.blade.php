...
{{--                    </li>--}}
                    ...
                    <li class="kt-menu__item {{ Request::is("ticket") ? 'kt-menu__item--here' : '' }}">
                        <a href="/ticket" class="kt-menu__link"><span class="kt-menu__link-text">Service Request</span></a>
                    </li>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Vehicle Tracking</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                <li class="kt-menu__item">
                                    <a href="https://track.easytrax.com.bd" class="kt-menu__link" target="_blank"><span class="kt-menu__link-text">Login to Easytrax Platform</span></a>
                                </li>
                                <li class="kt-menu__item">
                                    <a href="https://tracksolid.com" class="kt-menu__link" target="_blank"><span class="kt-menu__link-text">Login to Tracksolid Platform</span></a>
                                </li>
                            </ul>
                        </div>
                    </li>
