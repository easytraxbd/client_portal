...
{{--                        <img alt="Logo" src="/assets/media/logos/logo-4-sm.png" class="kt-header__brand-logo-sticky">--}}
                        <img alt="Logo" src="/images/easytrax/logos/easytrax_logo_white.png" class="kt-header__brand-logo-sticky" width="47px">
                    </a>
                    <div class="kt-footer__copyright">
                        2020&nbsp;&copy;&nbsp;
                        <a href="https://www.easytrax.com.bd/" target="_blank">Easytrax</a>
                    </div>
                </div>
